...
function postList() {
  renderedStr =
    "Last 10 posts in my blog.<br>More in [Flyhigher](<a target=\"_blank\" rel=\"noopener\" href=\"http://flyhigher.top\">http://flyhigher.top</a>)<br>"
  $.ajax({
    url: "/blog",
    timeout: 10000,
...
const logo =
  ...
  "  ,@@@@@@OOOOO`   .   =OO@@,   <br>" +
  " ,@@@@@@@@OO`  ,OOOO   OOO@@@, <br>" +
  ",O@@@@OOOO/  ,OOOOOO   OOO@@@@,<br>" +
  "O@@@@OOOO`  =OOOOOO[  ,OO@@@@OO<br>" +
  "@@@@@OOO.             =OO@@@@OO<br>" +
  "@@@@@OO   OOO]]OOOO   OOO@@@@OO<br>" +
  "O@@@@O   /OOO@@@@O^  =OOO@@@@OO<br>" +
  " @@@@^  =@OOO@@@@/  ,OO@O@@@@O <br>" +
  " ,@@@  ^@O@@@@OOO   OO@@@@OOO, <br>" +
  "  ,@@@O]/O@@@@OOOO]]OO@@@@OO,  <br>" +
...
function runCommand(command) {
  ...
  if (commandDet["name"] === "screenfetch") {
    ...
    return {
      content:
        ...
        logo +
        "</pre><div class=\"about info\">&nbsp;<br><span class=\"sf\">usr@axton.cc</span><br>OS: <span class=\"sf\">AxtonOs</span><br>Kernel: <span class=\"sf\">7.10.0-693.2.2.el7.x86_64</span><br>Shell: <span class=\"sf\">AxtonShell 2.0.0</span><br>Uptime: <span class=\"sf\">" +
        day +
        "d " +
        hour +
        "h " +
  ...
  if (commandDet["name"] === "uname") {
    if (!commandDet["args"][0]) {
      ...
      if (commandDet["args"][0] === "-a") {
        return {
          content:
            "AxtonOs axton.cc 7.10.0-693.2.2.el7.x86_64 #1 SMP Tue Sep 12 22:26:13 UTC 2017 x86_64 x86_64 x86_64 AxtonOs<br>",
          sta: true
        }
      }
      if (
  ...
  if (commandDet["name"] === "axtonshell") {
    if (!commandDet["args"][0]) {
      return {
        content:
          "Usage: axtonshell [OPTION]...<br>Set your preferences of the shell.<br><br> -b, Set the color of the background<br> -f, Set the color of the font<br> -a, Turn on/off the auto complete<br> -s, Turn on/off the soft keyboard<br> --help, Display this help and exit<br> --about, Display about infomation and exit<br>",
        sta: true
      }
    } else {
      if (
        ...
        return {
          content:
            "axtonshell: invalid option -- '" +
            commandDet["args"][0].substr(1) +
            "'<br>Try 'axtonshell --help' for more information.<br>",
          sta: false
        }
      }
      ...
      if (commandDet["args"][0] === "--about") {
        return {
          content:
            ...
            logo +
            "</pre><div class=\"about\">&nbsp;<br>Axton Shell 2.0.0.f59ed7a<br><span class=\"info\">Based on BASH<br>Written by <span class=\"js\">Javascript</span><br>Powered by <span class=\"nginx\">Nginx</span></span><br><br>Made with love by Axton</div><div class=\"clear\"></div></div><br>",
          sta: true
        }
      }
    }
...
function getReturn(firstCall) {
  ...
  if (rest["content"] !== undefined) {
    ...
    if (rest["content"] === "--CATMODE--") {
      ...
      if (firstCall) {
        prefixSub =
          "[" + username + "@axton.cc " + displayPosition + "]#" + "<br>"
      }
      ...
      $(".content").html(
        $(".content").html() +
          prefix +
          "Leave me a message, tap Enter to send. The first word separated by space will be your name.<br>"
      )
      $(".prefix,.preblank").hide()
      $(".preleave").show()
      lmMode = 1
